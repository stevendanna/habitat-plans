...
pkg_build_deps=(core/gcc core/make core/pkg-config xorg/xproto xorg/xextproto xorg/kbproto xorg/inputproto xorg/libpthread-stubs xorg/libXfixes xorg/fixesproto)
