...
pkg_deps=(core/glibc xorg/xlib xorg/libxcb xorg/libXau xorg/libXdmcp xorg/libxext xorg/libXi)
pkg_build_deps=(core/gcc core/make core/pkg-config xorg/xproto xorg/kbproto xorg/renderproto xorg/inputproto xorg/xextproto xorg/libpthread-stubs xorg/libXfixes xorg/fixesproto xorg/recordproto)
